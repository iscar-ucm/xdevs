...
public interface ControllerInterface {
     ...
     * @see mitris.sim.core.simulation.api.CoordinatorInterface#simInject(double, mitris.sim.core.modeling.InPort, java.util.Collection) 
     */
     ...
     * @param port Input port
     * @param values Set of values
     * @see mitris.sim.core.simulation.api.CoordinatorInterface#simInject(mitris.sim.core.modeling.InPort, java.util.Collection) 
     */
     ...
     * @see mitris.sim.core.simulation.api.CoordinatorInterface#simInject(double, mitris.sim.core.modeling.InPort, java.lang.Object) 
     */
     ...
     * @param port Input port
     * @param value Set of values
     * @see mitris.sim.core.simulation.api.CoordinatorInterface#simInject(mitris.sim.core.modeling.InPort, java.lang.Object) 
     */
