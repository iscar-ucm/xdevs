...
#ifndef SRC_XDEVS_CORE_TEST_EFP_MULT_H_
#define SRC_XDEVS_CORE_TEST_EFP_MULT_H_

#include "../../core/modeling/Port.h"
#include "../../core/modeling/Atomic.h"
#include "../../core/modeling/Event.h"

class Mult : public Atomic {
protected:
	Event nextEvent;
	int numToMult;
public:
	Port iIn;
	Port oOut;
	Mult(const std::string& name, int numToMult);
	virtual ~Mult();
...
#endif /* SRC_XDEVS_CORE_TEST_EFP_MULT_H_ */
